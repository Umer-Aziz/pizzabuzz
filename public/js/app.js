...
/*!**********************************!*\
  !*** ./resources/js/Services.js ***!
  \**********************************/
/*! exports provided: OrderPlace */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "OrderPlace", function() { return OrderPlace; });
...
function OrderPlace(formObject) {
...
function initAdmin(socket) {
  var tbodyOrder = document.querySelector('#tbodyOrder');
  var orders = [];
  var markup;
  ...
  socket.on('orderPlace', function (order) {
...
var Cart_Counter = document.getElementById("CartCounter");
...
var Orderstatus = document.querySelectorAll(".statusLine");
var HiddenInput = document.getElementById("InputHidden");
...
function _initStripe() {
  _initStripe = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee() {
    var stripe, card, mountWidget, PaymentType, cartFrom;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 3;
            return Object(_stripe_stripe_js__WEBPACK_IMPORTED_MODULE_2__["loadStripe"])("pk_test_51IInmcKtJexSjPcDQtmyMu1dg3TJ7quJ8zxNz8u0BTTAcfT4zTBQPMlxOGSIfzowSnJ5R4tBMhrLrO0C0BHZquiT00W5LKTXnZ");
          ...
          case 8:
            ...
            cartFrom = document.getElementById("cartFrom");

            if (cartFrom) {
              cartFrom.addEventListener("submit", function (e) {
                e.preventDefault();
                var formdata = new FormData(cartFrom);
                var formObject = {};
                ...
                if (!card) {
                  Object(_Services__WEBPACK_IMPORTED_MODULE_1__["OrderPlace"])(formObject);
                  return;
                } //verify card
...
__webpack_require__(/*! C:\Users\khan\Documents\Food_Website\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\Users\khan\Documents\Food_Website\resources\scss\app.scss */"./resources/scss/app.scss");
